...
var waitForJQuery = setInterval(function () {
    if (typeof $ != 'undefined') {
        ...
        setTimeout(() => {
            ...
            if(Cookies.get('dummybuttons')  == "true") {
                $("#dummybuttons").css("display", "block")
                $("#dumbbutton").text("Stupid Buttons: On")
                document.body.style.setProperty("--dumbbuttoncolor", "limegreen")
                Cookies.set('dummybuttons', true)
    
            } else {
                $("#dummybuttons").css("display", "none")
                $("#dumbbutton").text("Stupid Buttons: Off")
                document.body.style.setProperty("--dumbbuttoncolor", "red")
                Cookies.set('dummybuttons', false)
            }
...
function setting(settingtype) {
    ...
    if (settingtype == 'dumbbutton') {
        if ($("#dummybuttons").css("display") === "none") {
            $("#dummybuttons").css("display", "block")
            $("#dumbbutton").text("Stupid Buttons: On")
            document.body.style.setProperty("--dumbbuttoncolor", "limegreen")
            Cookies.set('dummybuttons', true)
